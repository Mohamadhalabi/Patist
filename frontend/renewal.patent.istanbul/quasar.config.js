    ...
    return {
        ...
        build: {
            ...
            env: {
                ...
                API: ctx.dev ? 'http://localhost:8000/api' : 'https://api.patent.istanbul/api',
            },
            // transpile: false,
            // publicPath: '/',
        ...
        framework: {
            ...
            // Quasar plugins
            plugins: ["Dialog", "Meta", 'Loading', 'Notify', 'Cookies'],
        },
        ...
        ssr: {
            ...
            prodPort: 4444, // The default port that the production server should use
