                            ...
                            <table role="presentation" border="0" cellpadding="0" cellspacing="0" style="margin: 10px">
                                <tr>
                                    <td>
                                        ...
                                        <p style="line-height: 30px">{{ trans('mail.instruction.has.been.received') }}</p><br>
                                        ...
                                        <p style="line-height: 30px">{{ trans('mail.if.you.have.any.trouble') }}
                                            <a href="{{ env('APP_URL') }}{{trans('mail.order')}}/{{$link}}" target="_blank">{{ env('APP_URL') }}{{trans('mail.order')}}/{{$link}}</a>
                                        </p>
                                    </td>
                                </tr>
                            </table>
