<div class="warning-content">
    <h1>Payment service is currently not available</h1>
    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="100.001px" height="70px" viewBox="0 0 100 68">
		...
		c-6.244-2.999-8.872-10.493-5.867-16.736c3.002-6.244,10.495-8.873,16.736-5.869C42.676,28.698,45.306,36.19,42.302,42.435z"  fill="none" stroke="#252525"/>    <animateTransform
		...
		C84.573,16.331,86.05,20.549,84.365,24.062z" fill="none" stroke="#252525"/>
                <animateTransform
                    attributeName="transform"
                    begin="0s"
                    dur="2s"
