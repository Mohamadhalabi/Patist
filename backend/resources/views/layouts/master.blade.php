...
<header>
  <div class="navbar navbar-dark bg-primary shadow-sm">
    <div class="container justify-content-center">
      <a href="{{ route('index') }}"class="navbar-brand"  style="color:white" >
        <strong>PATIST</strong>
      </a>
      <a href="{{ route('tr') }}" style="color:white"><strong>TR</strong></a>
      <a href="{{ route('data.list') }}" style="color:white;margin-left:15px"><strong>Data List</strong></a>
    </div>
  </div>
</header>
<main>
