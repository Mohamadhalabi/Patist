...
class ExistingRenewalProustInstructionWorkflow extends Workflow
{
     ...
     * @return void
     */
    public function execute($renewal = [], $reminder = [], $adminUser = [])
    {
        /**
        ...
        yield ActivityStub::make(ClientCommunicationToAcceptInstructionActivity::class, $renewal, $adminUser);
        ...
        yield ActivityStub::make(PaymentReminderActivity::class, $renewal, $this->reminderTime, $adminUser);
